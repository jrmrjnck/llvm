//===-- LC3bMachineFunctionInfo.h - Private data used for LC3b ----*- C++ -*-=//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the LC3b specific subclass of MachineFunctionInfo.
//
//===----------------------------------------------------------------------===//
...
#endif // !LC3b_MACHINE_FUNCTION_INFO_H
